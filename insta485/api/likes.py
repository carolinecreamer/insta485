...
def get_likes(postid_url_slug):
    ...
    if flask.request.method == 'POST':
        ...
        print(type(logname_likes_this), logname_likes_this['logname_likes_this'] )
        if(logname_likes_this['logname_likes_this'] == 1):
            return flask.jsonify({'logname': logname, 'message': "Conflict", "postid": postid, "status_code":409}), 409
        else:
